...
interface AppContextType {
  ...
  confirmReceipt: (batchId: string, confirmation: Omit<DeliveryConfirmation, 'id' | 'batchId' | 'timestamp'>) => void;
...
export function AppProvider({ children }: { children: ReactNode }) {
  ...
  const addMovement = async (movementData: Omit<SimpleMovement, 'id' | 'timestamp' | 'createdAt'>) => {
    ...
    try {
      ...
      console.log('✅ Stocks recarregados:', updatedStocks.length);
      console.log('🔍 Stock do item que acabamos de adicionar:', 
