        ...
        {!showScanner ? (
          <div className="text-center space-y-4">
            <div className="flex justify-center">
              <div className="rounded-full bg-[#3F76FF]/10 p-6">
                <Camera className="h-12 w-12 text-[#3F76FF]" />
              </div>
            </div>
            <Button
          ...
          <div className="space-y-4">
            <div 
              id={elementId} 
              className="rounded-lg overflow-hidden border-2 border-[#3F76FF] min-h-[300px]"
            />
            {isScanning && (
              <Button
                onClick={stopScanner}
