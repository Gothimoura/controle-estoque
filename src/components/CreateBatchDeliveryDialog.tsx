      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            <Truck className="h-5 w-5 text-[#3F76FF]" />
        ...
        <div className="space-y-4">
                    ...
                    <div key={unitId} className="p-4 space-y-3">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          <Badge className="bg-[#3F76FF]">{unit?.name}</Badge>
                        ...
                        return (
                          <div
                            ...
                            className={`flex items-center gap-3 p-2 rounded border transition-colors cursor-pointer ${
                              isSelected ? 'bg-blue-50 border-[#3F76FF]' : 'hover:bg-gray-50'
                            }`}
          ...
          {(selectedRequestIds.length > 0 || selectedFurnitureIds.length > 0) ? (
            <Alert className="bg-blue-50 border-[#3F76FF]">
